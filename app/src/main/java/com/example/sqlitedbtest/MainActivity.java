...
public class MainActivity extends AppCompatActivity {
    ...
    public void viewDataFromId(View view){
        ...
        if(result.getCount()==0){
            ...
            EditText fName=(EditText)findViewById(R.id.FirstName2);
            EditText surname=(EditText)findViewById(R.id.Surname2);
            EditText marks=(EditText)findViewById(R.id.Marks2);
            while (result.moveToNext()){
